...
void DialogObjectEdit::loadObjectData(int object_n) {
	...
	ui->npcGraphicSizeSpin_h->setValue(game_data.objects[object_n].size.heigth);
	...
	dataExchanger->npcGraphicSize_h = game_data.objects[object_n].size.heigth;
...
void DialogObjectEdit::saveObjectData(int object_n) {
	...
	game_data.objects[object_n].size.heigth = ui->npcGraphicSizeSpin_h->value();
