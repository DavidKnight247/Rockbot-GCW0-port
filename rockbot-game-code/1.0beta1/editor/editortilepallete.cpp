...
void EditorTilePallete::paintEvent(QPaintEvent *) {
   ...
   if (!currentPallete) {
	  filename = new QString(QString(EDITOR_FILEPATH)+"/data/images/tilesets/default.png");
   } else {
...
QString *EditorTilePallete::getPallete() {
   //return currentPallete;
	return new QString(QString(EDITOR_FILEPATH)+"/data/images/tilesets/default.png");
}
