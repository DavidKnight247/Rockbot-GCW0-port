		...
		for (int x=0; x<PASSWORD_GRID_SIZE; x++) {
            ...
            */
			if (_password_selected_balls[x][y] == 0) { // blue
                if (x == 1 && y == 0) {
                    // @TODO: add player #3 and player #4
                    //game_save.selected_player = 3;
                } else if (x == 5 && y == 3) {
				...
				*/
                ...
                std::cout << "red_ball x[" << x << "], y[" << y << "]" << std::endl;

                if (x == 1 && y == 0) {
                    game_save.selected_player = 2;
                } else if (x == 2 && y == 1) {
                    //@TODO - add playter #4 (kitty?)
                    //game_save.selected_player = 4;
                } else if (x == 0 && y == 2) {
...
void scenesLib::show_password()
{
    ...
    if (game_save.selected_player == 2) {
        selected_number.x = 1;
        selected_number.y = 0;
    ...
    if (game_save.selected_player == 3) {
        selected_number.x = 1;
        selected_number.y = 0;
