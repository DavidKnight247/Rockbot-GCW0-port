...
short int colision_verify(short int x_inc, short int y_inc, short int sprite_n, struct player_struct *playerObj);
void move_player(struct player_struct *pObj);
short int game_init();
void openInGameMenu(int player_n);
void show_dialog(int n, int place);
void checkScrolling(const short int x_inc, const short int y_inc, struct player_struct *playerObj);
