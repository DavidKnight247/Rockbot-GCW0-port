...
void npc_edit::on_frameUp_clicked()
{
    ...
    CURRENT_FILE_FORMAT::st_sprite_data temp = game_data.game_npcs[get_npc_index_from_id(_npcedit_tab_selectednpc)].sprites[ui->frame_list_selector->currentIndex()][ui->frameList_listWidget->currentRow()-1];
