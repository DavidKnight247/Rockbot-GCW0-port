...
#define RES_W 320
#define RES_H 240
#define RES_COLOR_DEPH 8                    // can't change this because of colorcycle
#define COLOR_COUNT 255                     // number of colors used in palette
...
#define CURRENT_FILE_FORMAT format_v_3_0_0
